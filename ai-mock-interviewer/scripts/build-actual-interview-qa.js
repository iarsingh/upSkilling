...
const sourceEntries = [
  ...
  ...JSON.parse(fs.readFileSync(path.join(answerBankDirectory, "actual-interview-gcp-platform-governance-round-2026-09-05.json"), "utf8")),
  ...JSON.parse(fs.readFileSync(path.join(answerBankDirectory, "actual-interview-jitendra-ai-platform-mlops-round-2026-09-05.json"), "utf8")),
  ...JSON.parse(fs.readFileSync(path.join(answerBankDirectory, "actual-interview-gke-jenkins-production-troubleshooting-round-2026-09-05.json"), "utf8")),
  ...JSON.parse(fs.readFileSync(path.join(answerBankDirectory, "actual-interview-aws-eks-banking-golang-round-2026-09-05.json"), "utf8")),
  ...JSON.parse(fs.readFileSync(path.join(answerBankDirectory, "actual-interview-coding-multicloud-solution-design-round-2026-09-05.json"), "utf8")),
  ...JSON.parse(fs.readFileSync(path.join(answerBankDirectory, "actual-interview-gke-anthos-workload-management-round-2026-09-05.json"), "utf8")),
  ...JSON.parse(fs.readFileSync(path.join(answerBankDirectory, "actual-interview-gcp-gke-gitops-sre-round-2026-09-05.json"), "utf8")),
  ...JSON.parse(fs.readFileSync(path.join(answerBankDirectory, "actual-interview-gcp-monitoring-drift-round-2026-09-05.json"), "utf8")),
  ...JSON.parse(fs.readFileSync(path.join(answerBankDirectory, "actual-interview-gcp-gke-platform-alignment-round-2026-09-05.json"), "utf8")),
  ...JSON.parse(fs.readFileSync(path.join(answerBankDirectory, "actual-interview-terraform-gcp-project-experience-2026-09-05.json"), "utf8")),
  ...JSON.parse(fs.readFileSync(path.join(answerBankDirectory, "actual-interview-gke-gateway-gitops-microservices-round-2026-09-05.json"), "utf8")),
