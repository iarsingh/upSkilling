...
```bash
python3 -m pytest gcp-cloud-engineering-portfolio/mlops_interview_portfolio
```

Validate market-stack coverage:

```bash
python3 -m pytest gcp-cloud-engineering-portfolio/mlops_interview_portfolio/tests/test_market_stack_coverage.py
```

Run Terraform formatting checks:

```bash
terraform -chdir=gcp-cloud-engineering-portfolio/mlops_interview_portfolio/01-gke-ml-platform-blueprint/terraform fmt -check
terraform -chdir=gcp-cloud-engineering-portfolio/mlops_interview_portfolio/04-cloud-build-gke-ml-cicd/terraform fmt -check
terraform -chdir=gcp-cloud-engineering-portfolio/mlops_interview_portfolio/05-vertex-ai-monitoring-blueprint/terraform fmt -check
terraform -chdir=gcp-cloud-engineering-portfolio/mlops_interview_portfolio/06-pubsub-ml-incident-automation/terraform fmt -check
terraform -chdir=gcp-cloud-engineering-portfolio/mlops_interview_portfolio/09-vertex-ai-huggingface-llmops/terraform fmt -check
terraform -chdir=gcp-cloud-engineering-portfolio/mlops_interview_portfolio/10-vertex-ai-mlops-control-plane/terraform fmt -check
terraform -chdir=gcp-cloud-engineering-portfolio/mlops_interview_portfolio/11-gcp-llm-aiops-gitops/terraform fmt -check
terraform -chdir=gcp-cloud-engineering-portfolio/mlops_interview_portfolio/12-chronos-supply/terraform fmt -check
terraform -chdir=gcp-cloud-engineering-portfolio/mlops_interview_portfolio/13-shield-llm/terraform fmt -check
terraform -chdir=gcp-cloud-engineering-portfolio/mlops_interview_portfolio/14-vision-edge/terraform fmt -check
terraform -chdir=gcp-cloud-engineering-portfolio/mlops_interview_portfolio/15-nexus-fraud/terraform fmt -check
terraform -chdir=gcp-cloud-engineering-portfolio/mlops_interview_portfolio/16-clear-route/terraform fmt -check
terraform -chdir=gcp-cloud-engineering-portfolio/mlops_interview_portfolio/17-ad-stream/terraform fmt -check
terraform -chdir=gcp-cloud-engineering-portfolio/mlops_interview_portfolio/18-aegis-sphere/terraform fmt -check
terraform -chdir=gcp-cloud-engineering-portfolio/mlops_interview_portfolio/19-aero-predict/terraform fmt -check
terraform -chdir=gcp-cloud-engineering-portfolio/mlops_interview_portfolio/20-omni-agent/terraform fmt -check
terraform -chdir=gcp-cloud-engineering-portfolio/mlops_interview_portfolio/21-graph-shield/terraform fmt -check
terraform -chdir=gcp-cloud-engineering-portfolio/mlops_interview_portfolio/22-lexi-stream/terraform fmt -check
terraform -chdir=gcp-cloud-engineering-portfolio/mlops_interview_portfolio/23-fin-pulse/terraform fmt -check
terraform -chdir=gcp-cloud-engineering-portfolio/mlops_interview_portfolio/24-bio-graph-rag/terraform fmt -check
terraform -chdir=gcp-cloud-engineering-portfolio/mlops_interview_portfolio/25-cyber-stream/terraform fmt -check
```

Run CLI demos:

```bash
python3 gcp-cloud-engineering-portfolio/mlops_interview_portfolio/02-model-promotion-gates/src/promotion_cli.py evaluate \
  --registry gcp-cloud-engineering-portfolio/mlops_interview_portfolio/02-model-promotion-gates/examples/registry.json \
  --model-id churn-model-v3 \
  --target staging

python3 gcp-cloud-engineering-portfolio/mlops_interview_portfolio/03-ml-observability-sre/src/ml_sre_report.py \
  --logs gcp-cloud-engineering-portfolio/mlops_interview_portfolio/03-ml-observability-sre/examples/inference_logs.jsonl

python3 gcp-cloud-engineering-portfolio/mlops_interview_portfolio/05-vertex-ai-monitoring-blueprint/src/monitoring_policy.py validate \
  --policy gcp-cloud-engineering-portfolio/mlops_interview_portfolio/05-vertex-ai-monitoring-blueprint/examples/model_monitoring_policy.json

python3 gcp-cloud-engineering-portfolio/mlops_interview_portfolio/06-pubsub-ml-incident-automation/src/incident_router.py \
  --alert gcp-cloud-engineering-portfolio/mlops_interview_portfolio/06-pubsub-ml-incident-automation/examples/model_drift_alert.json \
  --runbooks gcp-cloud-engineering-portfolio/mlops_interview_portfolio/06-pubsub-ml-incident-automation/config/runbooks.json

python3 gcp-cloud-engineering-portfolio/mlops_interview_portfolio/07-feature-store-consistency/src/feature_consistency.py validate \
  --contract gcp-cloud-engineering-portfolio/mlops_interview_portfolio/07-feature-store-consistency/examples/feature_contract.json \
  --offline gcp-cloud-engineering-portfolio/mlops_interview_portfolio/07-feature-store-consistency/examples/offline_snapshot.json \
  --online gcp-cloud-engineering-portfolio/mlops_interview_portfolio/07-feature-store-consistency/examples/online_metadata.json

python3 gcp-cloud-engineering-portfolio/mlops_interview_portfolio/08-batch-inference-quality-gates/src/batch_quality_gate.py evaluate \
  --manifest gcp-cloud-engineering-portfolio/mlops_interview_portfolio/08-batch-inference-quality-gates/examples/batch_manifest.json

python3 gcp-cloud-engineering-portfolio/mlops_interview_portfolio/09-vertex-ai-huggingface-llmops/src/llmops_release_gate.py evaluate \
  --model-card gcp-cloud-engineering-portfolio/mlops_interview_portfolio/09-vertex-ai-huggingface-llmops/examples/model_card.json \
  --eval-report gcp-cloud-engineering-portfolio/mlops_interview_portfolio/09-vertex-ai-huggingface-llmops/examples/evaluation_report.json \
  --deployment-config gcp-cloud-engineering-portfolio/mlops_interview_portfolio/09-vertex-ai-huggingface-llmops/examples/deployment_config.json

python3 gcp-cloud-engineering-portfolio/mlops_interview_portfolio/10-vertex-ai-mlops-control-plane/src/release_readiness.py evaluate \
  --candidate gcp-cloud-engineering-portfolio/mlops_interview_portfolio/10-vertex-ai-mlops-control-plane/examples/ml_release_candidate.json

python3 gcp-cloud-engineering-portfolio/mlops_interview_portfolio/11-gcp-llm-aiops-gitops/src/aiops_gitops.py propose \
  --alert gcp-cloud-engineering-portfolio/mlops_interview_portfolio/11-gcp-llm-aiops-gitops/examples/alert_payload.json \
  --runbooks gcp-cloud-engineering-portfolio/mlops_interview_portfolio/11-gcp-llm-aiops-gitops/examples/runbook_catalog.json

python3 gcp-cloud-engineering-portfolio/mlops_interview_portfolio/12-chronos-supply/src/chronos_supply_gate.py evaluate \
  --candidate gcp-cloud-engineering-portfolio/mlops_interview_portfolio/12-chronos-supply/examples/forecast_run.json

python3 gcp-cloud-engineering-portfolio/mlops_interview_portfolio/13-shield-llm/src/shield_llm_gate.py evaluate \
  --policy gcp-cloud-engineering-portfolio/mlops_interview_portfolio/13-shield-llm/examples/gateway_policy.json

python3 gcp-cloud-engineering-portfolio/mlops_interview_portfolio/14-vision-edge/src/vision_edge_gate.py evaluate \
  --release gcp-cloud-engineering-portfolio/mlops_interview_portfolio/14-vision-edge/examples/edge_release.json

python3 gcp-cloud-engineering-portfolio/mlops_interview_portfolio/15-nexus-fraud/src/nexus_fraud_gate.py evaluate \
  --release gcp-cloud-engineering-portfolio/mlops_interview_portfolio/15-nexus-fraud/examples/fraud_release.json

python3 gcp-cloud-engineering-portfolio/mlops_interview_portfolio/16-clear-route/src/clear_route_gate.py evaluate \
  --release gcp-cloud-engineering-portfolio/mlops_interview_portfolio/16-clear-route/examples/platform_release.json

python3 gcp-cloud-engineering-portfolio/mlops_interview_portfolio/17-ad-stream/src/ad_stream_gate.py evaluate \
  --release gcp-cloud-engineering-portfolio/mlops_interview_portfolio/17-ad-stream/examples/streaming_release.json

python3 gcp-cloud-engineering-portfolio/mlops_interview_portfolio/18-aegis-sphere/src/aegis_sphere_gate.py evaluate \
  --release gcp-cloud-engineering-portfolio/mlops_interview_portfolio/18-aegis-sphere/examples/platform_release.json

python3 gcp-cloud-engineering-portfolio/mlops_interview_portfolio/19-aero-predict/src/aero_predict_gate.py evaluate \
  --release gcp-cloud-engineering-portfolio/mlops_interview_portfolio/19-aero-predict/examples/fleet_release.json

python3 gcp-cloud-engineering-portfolio/mlops_interview_portfolio/20-omni-agent/src/omni_agent_gate.py evaluate \
  --release gcp-cloud-engineering-portfolio/mlops_interview_portfolio/20-omni-agent/examples/agent_platform_release.json

python3 gcp-cloud-engineering-portfolio/mlops_interview_portfolio/21-graph-shield/src/graph_shield_gate.py evaluate \
  --release gcp-cloud-engineering-portfolio/mlops_interview_portfolio/21-graph-shield/examples/graph_release.json

python3 gcp-cloud-engineering-portfolio/mlops_interview_portfolio/22-lexi-stream/src/lexi_stream_gate.py evaluate \
  --release gcp-cloud-engineering-portfolio/mlops_interview_portfolio/22-lexi-stream/examples/gateway_release.json

python3 gcp-cloud-engineering-portfolio/mlops_interview_portfolio/23-fin-pulse/src/fin_pulse_gate.py evaluate \
  --release gcp-cloud-engineering-portfolio/mlops_interview_portfolio/23-fin-pulse/examples/gpu_release.json

python3 gcp-cloud-engineering-portfolio/mlops_interview_portfolio/24-bio-graph-rag/src/bio_graph_rag_gate.py evaluate \
  --release gcp-cloud-engineering-portfolio/mlops_interview_portfolio/24-bio-graph-rag/examples/biograph_release.json

python3 gcp-cloud-engineering-portfolio/mlops_interview_portfolio/25-cyber-stream/src/cyber_stream_gate.py evaluate \
  --release gcp-cloud-engineering-portfolio/mlops_interview_portfolio/25-cyber-stream/examples/threat_release.json

python3 gcp-cloud-engineering-portfolio/mlops_interview_portfolio/26-kubeflow-gke-ml-factory/src/kubeflow_gke_gate.py evaluate \
  --release gcp-cloud-engineering-portfolio/mlops_interview_portfolio/26-kubeflow-gke-ml-factory/examples/kubeflow_platform_release.json

python3 gcp-cloud-engineering-portfolio/mlops_interview_portfolio/27-kubeflow-vertex-hybrid-pipelines/src/hybrid_pipeline_gate.py evaluate \
  --release gcp-cloud-engineering-portfolio/mlops_interview_portfolio/27-kubeflow-vertex-hybrid-pipelines/examples/hybrid_pipeline_release.json

python3 gcp-cloud-engineering-portfolio/mlops_interview_portfolio/28-atlas-ai-mlops-operating-system/src/atlas_ai_gate.py evaluate \
  --release gcp-cloud-engineering-portfolio/mlops_interview_portfolio/28-atlas-ai-mlops-operating-system/examples/atlas_ai_release.json
```
